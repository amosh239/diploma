"""Chapter 22: Profile-likelihood sweep over 9 Hawkes-α coefficients — NO regularization.

Same protocol as chapter 21, but with λ_l2 = 0 and α_l2 = 0 (no shrinkage at all):
loss = Σ_{u,t} [λ_{u,t} − y_{u,t} log λ_{u,t}], with bounds λ_u ∈ [0.001, 50], α_j ∈ [0, 10].
"""
...
OUT_DIR = Path("diploma/reports/22_profile_all_alphas_unreg")
...
def main() -> None:
    ...
    plot_grid(
        ...
        r"  (other params re-optimized, NO regularization: $\lambda_{\ell_2}=0,\ \alpha_{\ell_2}=0$)",
    )
    plot_grid(
